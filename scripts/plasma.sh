#!/usr/bin/env bash
sudo pacman -S plasma-desktop ark kvantum dolphin dolphin-plugins discover flatpak ffmpegthumbs kdegraphics-thumbnailers gimp kpipewire konsole sddm sddm-kcm systemsettings krunner plasma-firewall kcalc udiskie kcharselect kdf packagekit-qt6 fwupd --noconfirm --needed
