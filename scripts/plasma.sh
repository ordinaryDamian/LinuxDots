...
sudo pacman -S kio-extras kio-fuse xwaylandvideobridge noto-sans xsettingsd xdg-desktop-portal-kde packagekit qt5-graphicaleffects plasma-nm kdeplasma-addons plasma-pa --noconfirm --needed
