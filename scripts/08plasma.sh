...
$yay_cmd powerdevil  plasma-browser-integration plasma-disk plasma-integrations
$yay_cmd plasma-thunderbolt plasma-vault kdeplasma-addons plasma-sdk

# KDE System components
$yay_cmd bluedevil breeze-gtk drkonqi kde-gtk-config kgamma kinfocenter polkit-kde-agent
...
$yay_cmd qt5-graphicaleffects qt5-svg qt5-quickcontrols2 aurorea
...
$yay_cmd kdiff3 krename krdc kcron kfind kgpg kde-cli-tools
...
$yay_cmd kdeconnect kdenetwork-filesharing kdecoration ksystemstats kwayland 
$yay_cmd packagekit-qt6 qt6-wayland kinit kaccounts-integration kdialog layer-shell-qt
