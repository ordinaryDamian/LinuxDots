...
#VMware drivers
sudo pacman -S --noconfirm --needed open-vm-tools xf86-video-vmware mesa lib32-mesa
...
sudo pacman -S --needed --noconfirm duf btop fuse2fs exfatprogs fuse2 fuse3 man-db man-pages ffmpegthumbs nmap
sudo pacman -S --noconfirm --needed polkit starship tree gdb lolcat thefuck bind ddrescue dmidecode ethtool exfatprogs ndisc6 
sudo pacman -S --noconfirm --needed avahi networkmanager ntfs-3g dosfstools hdparm lftp mkinitcpio-nfs-utils nfs-utils
...
sudo pacman -S --noconfirm --needed netctl nm-connection-editor nss-mdns whois yt-dlp
...
sudo pacman -S --needed --noconfirm pipewire pipewire-audio pavucontrol lib32-pipewire pipewire-pulse pipewire-alsa pipewire-jack wireplumber alsa-utils alsa-firmware alsa-tools sof-firmware pamixer alsa-plugins alsa-ucm-conf alsa-card-profiles alsa-lib 
#Multimedia support
sudo pacman -S --noconfirm --needed ffmpeg ffmpegthumbnailer x264 x265 xvidcore
# Useful package installation
yay -S --needed --noconfirm hunspell hunspell-sk gstreamer-vaapi gst-plugins-bad gst-plugins-base gst-plugin-pipewire gst-plugins-ugly gst-plugins-good gst-libav gstreamer libva-mesa-driver lib32-libva-mesa-driver mesa-vdpau lib32-mesa-vdpau xdg-desktop-portal-gtk xdg-desktop-portal fastfetch lib32-pipewire
#Fonts and icons
